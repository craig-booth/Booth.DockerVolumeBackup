...
namespace Booth.DockerVolumeBackup.Test.Services
{
    public  class BackupNotificationServiceTests
    {
        ...
        public void ReceiveNotificationsForBackupStatusChangedEvent()
        {
            ...
            ((INotificationHandler<BackupStatusChangedEvent>)notificationService).Handle(event_, CancellationToken.None);
        ...
        public void ReceiveNotificationsForBackupVolumeStatusChangedEvent()
        {
            ...
            ((INotificationHandler<BackupVolumeStatusChangedEvent>)notificationService).Handle(event_, CancellationToken.None);
        ...
        public void NoNotificationsIfUnsubscribe()
        {
            ...
            ((INotificationHandler<BackupStatusChangedEvent>)notificationService).Handle(event2_, CancellationToken.None);
            backupId.Should().Be(12);
